<?php
/**
 * Template part for displaying Giving content in page template front.php
 *
	...
	<div class="pb-24">
		<div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center justify-end">
			...
			<div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left text-white">
				...
				<a href="<?php echo esc_url( site_url( '/giving/' ) ); ?>" class="mx-auto lg:mx-0 bg-blue text-white font-heavy font-bold my-6 py-2 px-4 hover:bg-blue-light hover:text-primary rounded-md border-none">Find Out More</a>
			</div>
		</div>
	</div>
</div>
