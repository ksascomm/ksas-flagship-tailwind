	...
	<div class="container mx-auto flex flex-wrap">
		<div class="flex w-full flex-wrap">
			...
			<div class="flex flex-wrap flex-row md:flex-row-reverse lg:pl-6 lg:w-2/3 mx-auto leading-relaxed  font-heavy font-bold pb-4">
				...
				<a href="https://twitter.com/JHUArtsSciences" class="py-3 px-4 text-blue hover:text-primary"><span class="fa-brands fa-x-twitter fa-2x"></span><span class="screen-reader-text">Twitter</span></a>
