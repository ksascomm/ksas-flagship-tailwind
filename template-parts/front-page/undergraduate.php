	...
	<div class="px-5 py-12 container bg-white h-fit mx-auto">
		<div class="wp-block-media-text has-media-on-the-right is-stacked-on-mobile" style="grid-template-columns:auto 40%">
			<div class="wp-block-media-text__content">
				...
				<div class="my-4"><a href="<?php echo esc_url( site_url( '/undergraduate-experience/' ) ); ?>" class=" bg-blue text-white font-heavy font-bold text-base lg:text-lg p-4 hover:bg-blue-light hover:text-primary rounded-md border-none">Explore Undergradute Education</a></div>
			</div>
			<figure class="wp-block-media-text__media not-prose"><img src="https://krieger.local/wp-content/uploads/2023/05/CIIP_impact-1024x573.jpg" alt="" class="wp-image-15056 size-full"/></figure>
		</div>
	</div>
</section>
