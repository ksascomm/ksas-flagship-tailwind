	...
	<div class="container mx-auto sm:px-5 lg:px-0 py-12">
		...
		<?php foreach ( $random_distinctions as $random_distinction ) : ?>
			<div class="p-4 lg:w-1/4 sm:w-1/2 w-full distinction h-56 relative mb-4 focus-within:shadow-lg focus-visible:ring">
					...
					<div class="absolute top-0 bottom-0 left-0 right-0 h-full w-full opacity-0 transition ease-in duration-200 flex flex-col justify-center bg-grey-lightest hover:opacity-100 focus:opacity-100 single-distinction" id="<?php echo $distinctions[ $random_distinction ]['statistic_id']; ?>" tabindex="0">
