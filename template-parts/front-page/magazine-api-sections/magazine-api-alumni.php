...
// Get the Feature taxonomy ID.
	$latest_alumni_url = 'https://magazine.krieger.jhu.edu/wp-json/wp/v2/posts?_fields=title,link,excerpt&volume=369&categories=69';
...
if ( ! empty( $alumni ) ) :?>
		<div class="magazine alumni grid grid-cols-1 md:grid-cols-4 gap-4" id="alumni">
