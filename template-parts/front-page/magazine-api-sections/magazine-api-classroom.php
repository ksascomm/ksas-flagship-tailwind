...
$latest_classroom_url = 'https://magazine.krieger.jhu.edu/wp-json/wp/v2/posts?_fields=title,link,excerpt&volume=366&categories=348,350';
...
if ( ! empty( $classroom ) ) :?>
		...
		<div class="magazine classroom grid grid-cols-4 gap-4" id="classroom">
