...
<ul>
				...
				<ul class="search-404">
					...
					<form method="GET" action="<?php echo esc_html( site_url( '/search' ) ); ?>" role="search" aria-label="Mobile Menu Search" class="bg-white">
						...
						<button type="submit" class="bg-grey-lightest hover:bg-secondary text-primary font-sans font-light hover:text-white py-2 px-4" aria-label="search">Search <span class="fa-solid fa-magnifying-glass"></span></button>
					</form>
					</li>
				</ul>
				</li>
